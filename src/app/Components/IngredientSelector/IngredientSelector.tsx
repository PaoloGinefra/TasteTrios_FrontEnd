        ...
        <div className="flex flex-col items-center">
            ...
            >
                <div className="relative flex w-full max-w-[24rem]">
                    ...
                    >
                        {isLoading ? (
                            <svg className="animate-spin h-4 w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                <circle className="" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
                                <path className="" fill="currentColor" d="M4 12a8 8 0 018-8v8H4z"></path>
                            </svg>
                        ) : (
                            "Add"
                        )}
